...
public class AnnouncePageMock {
	...
	"})()" + "\n" +
	"</script>" + "\n" +
	"<link rel=\"shortcut icon\" href=\"http://www.gstatic.com/sites/p/793e3f/system/app/images/favicon.ico\" type=\"image/x-icon\" />" + "\n" +
	"<link rel=\"apple-touch-icon\" href=\"http://www.gstatic.com/sites/p/793e3f/system/app/images/apple-touch-icon.png\" type=\"image/png\" />" + "\n" +
	...
	"</script>" + "\n" +
	"<link rel=\"stylesheet\" type=\"text/css\" href=\"http://www.gstatic.com/sites/p/793e3f/system/app/pagetypes/announcements/announcements.css\" />" + "\n" +
	"<script>" + "\n" +
	"webspace = {};" + "\n" +
	...
	"\\n" +
	"webspace.page = {\"locale\":\"ja\",\"state\":\"\",\"wuid\":\"wuid:gx:86f8a7f7feaf53c\",\"properties\":{},\"type\":\"announcements\",\"canChangePath\":true,\"parentWuid\":\"wuid:gx:417850bb3f16b580\",\"revision\":12,\"title\":\"Announcements\",\"isRtlLocale\":false,\"bidiEnabled\":false,\"siteLocale\":\"ja\",\"name\":\"announcement\",\"path\":\"/Home/announcement\",\"isSiteRtlLocale\":false,\"parentPath\":\"/Home\"};" + "\n" +
	"\\n" +
	"\\n" +
	"var editorResources = [" + "\n" +
	"  'http://www.gstatic.com/sites/p/793e3f/system/js/trog_edit__ja.js'," + "\n" +
	"  'http://www.gstatic.com/sites/p/793e3f/system/app/css/trogedit.css'," + "\n" +
	"  '/_/rsrc/1253722969891/system/app/css/editor.css'" + "\n" +
	"];" + "\n" +
	"\\n" +
	"var JOT_clearDotPath = \"http://www.gstatic.com/sites/p/793e3f/system/app/images/cleardot.gif\";" + "\n" +
	"\\n" +
	"var JOT_userRelTimeStrs = [\"1 分前\", \"{0} 分前\", \"1 時間前\", \"{0} 時間前\"];" + "\n" +
	"\\n" +
	"\\n" +
	"\\n" +
	"\\n" +
	...
	"              </script>" + "\n" +
	"<link rel=\"stylesheet\" type=\"text/css\" href=\"http://www.gstatic.com/sites/p/793e3f/system/app/themes/garden/standard-css-garden-ltr-ltr.css\" />" + "\n" +
	"<link rel=\"stylesheet\" type=\"text/css\" href=\"/_/rsrc/1253722969932/system/app/css/overlay.css?cb=garden2100%25%25150goog-ws-right\" />" + "\n" +
	...
	"</a>" + "\n" +
	"<h2 style=\"display:none;\"><a href=\"http://www.sean-nos.net/\" dir=\"ltr\">Sean-nós</a></h2>" + "\n" +
	"</td>" + "\n" +
	...
	"        }" + "\n" +
	"    //]]>" + "\n" +
	"</script><script xmlns=\"http://www.w3.org/1999/xhtml\" type=\"text/javascript\">JOT_insertRelDate(1253755381847, \"2009/09/23 18:23\", true, \"ltr\");</script>‎<noscript xmlns=\"http://www.w3.org/1999/xhtml\">‎2009/09/23 18:23‎</noscript>‎ に Takayuki Konishi が投稿" + "\n" +
	"\\n" +
	"                  " + "\n" +
	"                </span>" + "\n" +
	"\\n" +
	...
	"<span class=\"timestamp\">" + "\n" +
	"<script xmlns=\"http://www.w3.org/1999/xhtml\" type=\"text/javascript\">JOT_insertRelDate(1253755173654, \"2009/09/23 18:19\", true, \"ltr\");</script>‎<noscript xmlns=\"http://www.w3.org/1999/xhtml\">‎2009/09/23 18:19‎</noscript>‎ に Takayuki Konishi が投稿" + "\n" +
	"\\n" +
	"                  " + "\n" +
	"                </span>" + "\n" +
	"\\n" +
	...
	"</div>" + "\n" +
	"<div class=\"announcement\">" + "\n" +
	"<h4><a href=\"/Home/announcement/4tsukinorenshuukai\" dir=\"ltr\">4月の練習会</a></h4>" + "\n" +
	"<span class=\"timestamp\">" + "\n" +
	"                  " + "\n" +
	"  " + "\n" +
	"  " + "\n" +
	"  ‎<span xmlns=\"http://www.w3.org/1999/xhtml\" dir=\"ltr\">‎2009/03/30 8:25‎</span>‎ に Takayuki Konishi が投稿" + "\n" +
	"\\n" +
	"                  " + "\n" +
	"                </span>" + "\n" +
	"\\n" +
	"<p>" + "\n" +
	"<table xmlns=\"http://www.w3.org/1999/xhtml\" cellspacing=\"0\" class=\"sites-layout-name-one-column sites-layout-hbox\"><tbody><tr><td class=\"sites-layout-tile sites-tile-name-content-1\"><div dir=\"ltr\">練習会、4月分を更新しました。</div></td></tr></tbody></table>" + "\n" +
	"</p>" + "\n" +
	"<div class=\"postfooter\">" + "\n" +
	"<p>" + "\n" +
	"</p>" + "\n" +
	...
	"\\n" +
	"        " + "\n" +
	"      <strong xmlns=\"http://www.w3.org/1999/xhtml\">1 - 10</strong> / <strong xmlns=\"http://www.w3.org/1999/xhtml\">12</strong> 件" + "\n" +
	"        " + "\n" +
	"\\n" +
	"      " + "\n" +
	...
	"</div></li>" + "\n" +
	"<li class=\"\"><div dir=\"ltr\" style=\"padding-left: 5px;\"><a href=\"http://www.sean-nos.net/system/app/pages/sitemap/hierarchy\" jotId=\"wuid:gx:17a\">サイトマップ</a>" + "\n" +
	"</div></li>" + "\n" +
	"</ul>" + "\n" +
	"\\n" +
	"</div>" + "\n" +
	...
	"  </script>" + "\n" +
	"<script xmlns=\"http://www.w3.org/1999/xhtml\" src=\"http://www.gstatic.com/sites/p/793e3f/system/js/jot_min_announcements_view__ja.js\"></script>" + "\n" +
	"<script xmlns=\"http://www.w3.org/1999/xhtml\" type=\"text/javascript\">" + "\n" +
	...
	"  if (editorResources) {" + "\n" +
	"    editorResources.push('/_/rsrc/1253723017817/system/app/themes/garden/standard-css-garden-ltr-ltr.css');" + "\n" +
	"\\n" +
	"  }" + "\n" +
	"  </script>" + "\n" +
	"<script xmlns=\"http://www.w3.org/1999/xhtml\" type=\"text/javascript\">" + "\n" +
